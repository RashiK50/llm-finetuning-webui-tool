...
const navItems = [
  ...
  { name: 'Model Setup', path: '/model-setup', icon: Settings },
  ...
  { name: 'Chat Playground', path: '/chat', icon: MessageSquareCode },
];
            ...
            className={({ isActive }) =>
              clsx(
                ...
                isActive 
                  ...
                  : "text-textMuted hover:bg-surfaceHover hover:text-textMain border border-transparent"
              )
            }
          >
            <item.icon size={18} />
